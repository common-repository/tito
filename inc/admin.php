		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th scope="row"><label class="description" for="tito_settings[plugins]"><?php _e('Plugins','tito_domain'); ?></label></th>
						<td><input id="tito_settings[plugins]" name="tito_settings[plugins]" type="text" value="<?php echo $tito_options['plugins']; ?>" /><p class="description">(Optional) Enter a comma separated list of widget plugins e.g. <strong><em>hits,test_mode</em></strong>. For more info about plugins see the <a href="https://ti.to/docs/api/widget#tito-widget-v2-plugins" target="_blank">Tito widget docs</a>.</p></td>
					</tr>
				</tbody>
			</table>
			<p class="submit">
