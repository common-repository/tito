...
3. Add your event path to the Tito settings page. For example, if the event is live at [https://ti.to/ultimateconf/2013](https://ti.to/ultimateconf/2013), then the event path is: `ultimateconf/2013`
